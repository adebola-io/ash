...
var PortfolioWorks = []shared.PortfolioWork{
	{
		...
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/bullet.svg",
			SvgWidth: "40%",
			Banner:   "",
			Theme:    [3]int{0, 28, 73},
		},
		Info: shared.PortfolioWorkInfo{
			Tagline: "JSX web components.",
			Brief:   "Bullet is a simple library that leverages JSX templates and custom elements for building web UIs",
			Full:    "",
		},
		Links: shared.PortfolioLinks{
			Base:   "https://github.com/adebola-io/bullet",
			Github: "https://github.com/adebola-io/bullet",
			Live:   "https://github.com/adebola-io/bullet",
		},
		Tags: []string{"Frameworks", "JSX", "Reactivity", "Web", "Web Components"},
	},
	{
		Id:        "00001",
		Name:      "Whirlwind",
		...
		IsOngoing: true,
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/whirlwind.svg",
			SvgWidth: "40%",
			Banner:   "",
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/spry.svg",
			SvgWidth: "50%",
			Banner:   "",
			Theme:    [3]int{97, 0, 94},
		},
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/quizwiz.svg",
			SvgWidth: "91%",
			// Banner: shared.BASE_URL + "/images/quizwiz.png",
			Banner: "",
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/sefunmi-ash-background-logo.png",
			SvgWidth: "51%",
			Banner:   "",
	...
	},
	{
		...
		Type: "other",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/siphon.png",
			SvgWidth: "86%",
			Banner:   "",
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/cadence.svg",
			SvgWidth: "35%",
			// Banner: shared.BASE_URL + "/images/cadence.png",
			Banner: "",
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/p1.png",
			SvgWidth: "80%",
			Banner:   "",
			Theme:    [3]int{2, 2, 2},
		},
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/sojourner-icon.png",
			SvgWidth: "72%",
			Banner:   "",
			Theme:    [3]int{0, 14, 53},
		},
		Info: shared.PortfolioWorkInfo{
			...
			Brief:   "Sojourner is a website concept for a company specializing in space tourism and interstellar travel.",
			Full:    "",
		},
		Links: shared.PortfolioLinks{
	...
	},
	{
		...
		Type: "app",
		View: shared.PortfolioWorkView{
			Svg:      shared.BASE_URL + "/images/studybud.svg",
			SvgWidth: "80%",
			Banner:   "",
			Theme:    [3]int{7, 0, 69},
		},
